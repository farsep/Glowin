...
public record ReservaOutput(Long id, String estado, LocalDate fecha, LocalTime hora, EmpleadoOutput empleado, UsuarioOutput usuario, ServicioOutput servicio ) {
